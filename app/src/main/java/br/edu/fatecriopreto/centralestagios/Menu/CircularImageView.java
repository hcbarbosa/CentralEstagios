    ...
    public class CircularImageView extends ImageView {
        ...
        private void init(Context context, AttributeSet attrs, int defStyle) {
            ...
            if(hasBorder) {
                ...
                setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_borderColor, Color.BLACK));
            }
        ...
        // Update shadow layers based on border/selector state and visibility.
